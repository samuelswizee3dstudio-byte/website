...
| `colour_custom_label` | `Tell us your colours` | Label for the free-text box shown when the chosen colour is `Custom`. A `Custom` entry in either colour list turns the box on; the checkout requires it and refuses wording without it |
